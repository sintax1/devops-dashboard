(function () {
  ...
  angular.module('DevopsDashboard.services.sidebar', ['ngResource', 'DevopsDashboard.services.userdashboard'])

    // User Sidebar Menu Service
    /** @ngInject */
    .factory('SidebarService', function($resource, UserDashboard){
      ...
      var refreshMenu = function() {
        ...
        UserDashboard.query(function(data) {
